...
- **Cada teléfono juega ambos roles BLE a la vez**: anuncia el servicio Vengala
...
- **Protocolo binario propio** ([Protocol.kt](app/src/main/java/com/vengala/app/mesh/Protocol.kt)):
...
- **Enrutamiento por inundación controlada** ([MeshRouter.kt](app/src/main/java/com/vengala/app/mesh/MeshRouter.kt)):
...
2. Abre la carpeta del proyecto (`d:\Apps\vengala`) con **File → Open**.
...
1. Antes de que muera la señal: uno del parche instala Vengala y se la pasa a los
...
- Los fabricantes agresivos con la batería (Xiaomi, Huawei…) pueden matar el
  servicio: excluye Vengala de la optimización de batería.
