...
class Settings(context: Context) {
    ...
    private val prefs: SharedPreferences = try {
        ...
        EncryptedSharedPreferences.create(
            ...
            val legacy = context.getSharedPreferences("bengala", Context.MODE_PRIVATE)
        ...
        context.getSharedPreferences("bengala", Context.MODE_PRIVATE)
    }
    ...
    var partyCode: String
        get() = prefs.getString("partyCode", null) ?: "bengala"
