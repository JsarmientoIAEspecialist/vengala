package com.bengala.app.ui.theme
...
private val BengalaColors = darkColorScheme(
    primary = NeonMagenta,
...
private val BengalaType = Typography(
...
@Composable
fun BengalaTheme(content: @Composable () -> Unit) {
    isSystemInDarkTheme() // la ignoramos: Bengala vive de noche
    MaterialTheme(
        colorScheme = BengalaColors,
        typography = BengalaType,
        content = content,
    )
}
